...
#SBATCH --output=table_w_sam_llama_final%j.out
#SBATCH --error=table_w_sam_llama_final%j.err
...
CHECKPOINT_HOME="$HOME/table_w_samples_llama_summary_checkpoint.json"
CHECKPOINT_TMP="$TMPDIR/table_w_samples_llama_summary_checkpoint.json"
...
python $HOME/tables_w_samples_llamajob.py "$TMPDIR/observations.json" "$TMPDIR/tables.csv" "$TMPDIR/llama_summaries_out"
